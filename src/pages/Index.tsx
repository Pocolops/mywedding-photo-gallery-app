  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-200 relative overflow-hidden font-serif">
      ...
      <div className="flex flex-col items-center justify-center flex-1 relative">
        ...
        <div 
          className={`absolute top-[68%] left-[25%] text-[0.8rem] tracking-[0.3em] text-gray-700 font-normal uppercase transition-all duration-[3000ms] ease-[cubic-bezier(0.25,0.46,0.45,0.94)] ${
            animationPhase >= 1
